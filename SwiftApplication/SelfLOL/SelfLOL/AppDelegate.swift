...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        dispatch_async(globalQueue) { () -> Void in
            if let path = NSBundle.mainBundle().pathForResource("rune", ofType: "json")
            {
                do {
                    ...
                    if let runesMap: NSArray = jsonResult!["runesMap"] as? NSArray
                    {
                        for rune in runesMap {
                            let runeId = (rune["runeId"] as? CLong)!
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SelfLOL", withExtension: "momd")!
